...
int 	main(void) {
	...
	}
	{
		std::cout << "__________________________________________________________________" << std::endl;
		std::cout << std::endl << std::endl;
		NinjaTrap Doctor = 	NinjaTrap("Doctor");
		ScavTrap Challenger = ScavTrap("Challenger");
		FragTrap NoImg = FragTrap("NO-IMAGINATION");

		std::cout << std::endl;
		Challenger.describeYourself();
		std::cout << std::endl << RED;
		Doctor.ninjaShoebox(Challenger);
		std::cout << std::endl;
		Challenger.describeYourself();
		std::cout << std::endl;
		Doctor.ninjaShoebox(NoImg);
		Doctor.meleeAttack("Rabbit");
		Doctor.ninjaShoebox(Doctor);
	...
	}
	{
		...
		NinjaTrap Target = NinjaTrap("Ninja");
